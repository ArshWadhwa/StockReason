...
export function App() {
      ...
      <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
        ...
        <header className="shell">
          <nav className="landing-nav">
            <div className="landing-nav-brand" onClick={() => setPageMode('home')}>
  ...
  return (
    <div className="dashboard-mode">
      <div className="shell" style={{ paddingBottom: 0, paddingTop: 24 }}>
        <header className="topbar">
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div className="navnote">
              NIFTY 50 · AI Analysis Workspace
            </div>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', gap: '24px', alignItems: 'start' }}>
          ...
          <aside style={{
            ...
            <div style={{ borderTop: '1px solid #1c1c1c', paddingTop: '14px' }}>
              <label style={{ fontFamily: 'var(--mono)', fontSize: '11px', color: 'var(--dash-muted)', textTransform: 'uppercase' }}>
                Company
              </label>
              <select
            ...
            <div style={{ borderTop: '1px solid #1c1c1c', paddingTop: '14px' }}>
              <div style={{ fontFamily: 'var(--mono)', fontSize: '11px', color: 'var(--dash-muted)', textTransform: 'uppercase', marginBottom: '8px' }}>
                Analysis Views
              </div>
